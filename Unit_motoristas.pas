    ...
    deu_erro := false;
      ...
      begin
        ...
        if Form_menu.ErroBD(E.Message, 'PK_Motoristas') = 'Sim' then
         Showmessage('Codigo já cadastro!')
        else
  ...
  try
    ...
    begin
      ...
      if Form_menu.ErroBD(E.Message, 'FK_Onibus_Motoristas')  = 'Sim' then
        Showmessage('Impossível atualizar o código pois existem Ônibus ligados a esta Motorista!')
...
begin
  ...
  try
    ...
    begin
      deu_erro := true;
      if Form_menu.ErroBD(E.Message, 'FK_Onubis_Motoristas') = 'Sim' then
        showmessage('Impossivel excluir pois existem Ônibus ligados a este Motorista!')
      else
        showmessage( 'Ocorreu o seguinte erro' + E.Message);
      end;
    end;
